package ec.com.sofka.appservice.account.queries.responses;
...
public class AccountResponse {
    ...
    public AccountResponse(String accountId, BigDecimal balance, String accountNumber, String accountHolder) {
        this.accountId = accountId;
        this.balance = balance;
        this.accountNumber = accountNumber;
        this.accountHolder = accountHolder;
